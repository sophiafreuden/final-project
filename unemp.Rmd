...
```{r}
# png("table2.png", width = 576, height = 576, res = 120)
# table2
# dev.off()
# 
# file_copy(
...
# Georgie recommended I add a coefficients table to my regression
# to provide additional data. I'm having a hard time getting this
# to work using gt() so I will need to spend more time on it to
# make it functional.
```
